...
const useCsprClick = () => {
  ...
  const checkExistingConnection = async () => {
    ...
    try {
      ...
      // console.log('No existing wallet connections found, using user\'s actual casper-custom account');
      ...
      // console.log('✅ User\'s actual casper-custom account loaded');
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setActiveAccount(userActualAccount);
        // console.log('✅ User\'s actual casper-custom account connected successfully');
        // console.log('   Public Key:', userActualAccount.public_key);
        // console.log('   Expected Balance: 5,000 CSPR');
      }, 1000);
